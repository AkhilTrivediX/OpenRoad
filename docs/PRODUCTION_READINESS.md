...
Next branch: `feat/settings-integrations-ui`

Purpose:

- Add a progressive-disclosure Settings surface for GitHub connection state, manual sync enqueue, and sync job visibility.
