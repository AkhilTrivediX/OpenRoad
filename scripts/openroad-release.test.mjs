      ...
      release: {
        ...
        rollback: {
          dataMigration: expect.stringContaining(
            "OpenRoad state schema 6; integration metadata schema 3; session metadata schema 2; team metadata schema 2"
          )
        },
        version: "0.1.0-rc.1"
      },
...
async function writeBuildArtifacts(root) {
  ...
  await writeFile(join(root, "server", "team.ts"), "export const openRoadTeamSchemaVersion = 2;");
