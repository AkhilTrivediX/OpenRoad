...
- Known unresolved risks: Password/OAuth auth, direct SMTP/provider invitation sending, account recovery, deeper member management UI, automated browser E2E, managed SQL migrations, and hosted billing remain future slices. JSONL invitation delivery handoff was completed in a later slice.
