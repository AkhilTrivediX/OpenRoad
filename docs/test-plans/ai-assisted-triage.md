...
- Changelog suggestion does not include internal comments, hidden comments, private changelog notes, notification outbox bodies, integration secrets, or raw provider payloads.
