...
- Branch: `feat/model-adapter-foundation`
- Commit SHAs: `f9f169e` test plan; `35890bb` implementation; `99d6452` evidence record.
...
- Commands run:
  ...
  - `pnpm release:verify` passed at the branch evidence checkpoint and is rerun at final branch tip before merge.
