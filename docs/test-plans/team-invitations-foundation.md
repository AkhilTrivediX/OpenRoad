...
- Known unresolved risks: Password auth, OAuth account login, email invitation delivery, account recovery, and deeper member management remain future production slices. Invitation management UI and invite-token member sessions were completed in later slices.
