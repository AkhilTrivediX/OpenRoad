...
- Known unresolved risks: Global organization directory, email verification, SSO/MFA/passkeys, SCIM, account deletion, hosted org admin, and billing remain future production slices. Password recovery was completed later in `feat/account-recovery-foundation`.
